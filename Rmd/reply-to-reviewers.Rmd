...
**We agree. We've removed many of the subsection headings and used your suggested section title.**
...
**We didn't write out learning objectives at the time of working with these students. Back then, we were new to research mentoring. We now are more explicit while designing projects with students.**
...
**Thank you for raising this issue. We agree that it needs clarification. We've added text to address this at lines ___ on page .**
...
**Yes, although we were new research mentors when we began working with these two students. Regretably, we didn't structure our conversations as we would now.** 
...
**Yes, we completely agree. We've added text to explain what crontab is and what it does. We've also pointed readers to R packages, for Windows and Mac, that allow one to circumvent the need to directly interact with crontab.** 
...
**Thank you. We've now added text about the student projects. We've also explicitly pointed out what you say in the last sentence - that there are a variety of ways in which an instructor could choose to use this article. We've also added more references to point readers to other researchers' work with Twitter.**
...
**We've attempted to address these concerns by writing more about the original two student projects.** 
