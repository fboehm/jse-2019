...
dynamic content of tweets over time particularly intrigued us. We 
...
functions to break the tweet text into individual words for latent Dirichlet allocation. We discarded commonly used "stop words" 
and emojis. 
...
We then inspected topic contents at each of the five time points.
