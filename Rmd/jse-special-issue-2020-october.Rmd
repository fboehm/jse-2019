...
allocation models [@blei2003latent] to infer topics on three consecutive days centered 
...
Mac users may need to slightly amend the above line to conform to requirements of their operating system's `crontab`. Windows users may want to schedule task with the R package `taskscheduleR`, which interacts with the Windows task scheduler. 
